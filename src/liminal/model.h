...
public:
    ...
    bool flip_texture = true; // whether to flip the texture coordinates or not, default is true

    // constructor, expects a filepath to a 3D model.
    Model(string const &path, bool gamma = false, bool flip_texture = true) : gammaCorrection(gamma), flip_texture(flip_texture)
    {
        loadModel(path);
    }
...
private:
    ...
    {
        // Conditionally add the FlipUVs flag based on flip_texture
